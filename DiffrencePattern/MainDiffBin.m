...
%% Binsize
name=NameDs(DatasetNum);
[BestFeature] = DiffPattern(name);
...
disp('Feature Rank 0-1 Normalization (With Diff Pattern)-Weight: ent+ - ent -:');
% [s,index]=sort(W21_EntDs01_1(2,:)-W21_EntDs01_1(1,:));
disp(indexw1);
disp('================================================================');
disp('Feature Rank 0-1 Normalization (Without Diff Pattern)Weight=Entropy1:');
disp(indexw2);
disp('================================================================');
